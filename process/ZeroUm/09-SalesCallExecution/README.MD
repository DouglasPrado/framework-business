...
### Depende de
- [TargetUserIdentification](../02-TargetUserIdentification/process.MD) – perfis e priorização.
- [UserInterviewValidation](../03-UserInterviewValidation/process.MD) – linguagem e objeções.
