...
- Hipóteses priorizadas a partir de processos anteriores (ex: [ProblemHypothesisDefinition](../01-ProblemHypothesisDefinition/process.MD))
- Perfis de usuários-alvo identificados (ex: [TargetUserIdentification](../02-TargetUserIdentification/process.MD))
...
- Perfis priorizados em [TargetUserIdentification](../02-TargetUserIdentification/process.MD)
