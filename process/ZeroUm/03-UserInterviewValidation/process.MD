...
- Confirmar perfis-alvo que serão abordados (com base em [TargetUserIdentification](../02-TargetUserIdentification/process.MD))
...
- Perfis priorizados ([TargetUserIdentification](../02-TargetUserIdentification/process.MD))
...
- [TargetUserIdentification/process.MD](../02-TargetUserIdentification/process.MD) – fornece perfis e canais
- [ProblemHypothesisDefinition/process.MD](../01-ProblemHypothesisDefinition/process.MD) – base para hipóteses
