"""
Teste standalone do sistema de monitoramento (sem depender do framework completo).
"""
...
# Import direto do módulo monitoring
exec(open("agents/framework/observability/monitoring.py").read(), globals())
exec(open("agents/framework/observability/exporters.py").read(), globals())
...
def test_monitoring_system():
    ...
    export_dir = Path("drive/_monitoring_test")
    ...
    print("=" * 80)
    print()
    print(f"Arquivos exportados em: {export_dir.resolve()}")
    print()
