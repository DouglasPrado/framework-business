...
from framework.orchestration.pipeline import (
    ExecuteStage,
    PersistStage,
    PipelineResult,
    PipelineStage,
...
from framework.orchestration.registry import (
    PluginMetadata,
    PluginRegistry,
    get_process_registry,
    get_strategy_registry,
)
from framework.orchestration.graph import (
    GraphEdge,
    GraphNode,
    OrchestrationGraph,
)
...
try:
    from framework.orchestration.langgraph_adapter import (
