...
from agents.framework.security.controls import (
    SecurityConfig,
    CommandValidator,
    PathValidator,
    RateLimiter,
...
class TestExecutionTools:
    ...
    def test_git_status_tool(self):
        ...
        from agents.framework.tools.builtin.execution import _git_status
    ...
    def test_mkdir_tool(self):
        ...
        from agents.framework.tools.builtin.execution import _mkdir
