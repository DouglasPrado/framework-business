...
try:  # pragma: no cover - dependência obrigatória
...
except ImportError as exc:  # pragma: no cover - ambiente sem dependências
    raise RuntimeError(
        "O pacote 'deepagents' é obrigatório para este framework. "
    ...
    raise RuntimeError("Falha ao inicializar o runtime deepagents.") from exc
